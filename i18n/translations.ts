...
export const translations = {
  en: {
    ...
    pushSubscriptionSuccess: 'Successfully subscribed to notifications!',
    pushSubscriptionFailed: 'Failed to subscribe to notifications.',
    pushUnsubscriptionSuccess: 'Successfully unsubscribed from notifications.',
    pushUnsubscriptionFailed: 'Failed to unsubscribe from notifications.',
  ...
  ar: {
    ...
    emailOrMobile: 'البريد الإلكتروني أو اسم المستخدم',
    loginWithEmail: 'تسجيل الدخول بالبريد الإلكتروني',
    or: 'أو',
    emailVerificationSent: 'تم إرسال رابط التحقق إلى بريدك الإلكتروني. الرجاء مراجعة صندوق الوارد.',
    pleaseVerifyEmail: 'الرجاء التحقق من بريدك الإلكتروني قبل تسجيل الدخول. تحقق من صندوق الوارد الخاص بك للحصول على رابط التحقق.',
    ...
    confirmDeleteRole: 'هل أنت متأكد من حذف هذا الدور؟ قد يكون مستخدماً.',
    settings: 'الإعدادات',
    ...
    settingsTabPayments: 'طرق الدفع عبر الإنترنت',
    ...
    settingsTablesDescription: 'حدد إجمالي عدد الطاولات المتاحة للطلبات داخل المكان.',
    ...
    topGovernoratesBySales: 'المحافظات الأكثر شراءً',
    ...
    profitNotice: 'الربح تقديري بناءً على هامش 70% من الإيرادات حيث أن بيانات التكلفة غير متوفرة.',
    ...
    systemActivationSubtitle: 'إدارة تفعيل النظام وحالة الاشتراك.',
    ...
    dataRefreshFailed: 'تعذر تحديث البيانات.',
    accountVerificationFailed: 'تعذر التحقق من الحساب مع الخادم. يرجى المحاولة مرة أخرى.',
    profileSaveFailed: 'فشل في حفظ الملف الشخصي.',
    profileUpdateFailed: 'فشل في تحديث الملف الشخصي.',
    networkRequestFailed: 'فشل الاتصال بالشبكة. يرجى التحقق من اتصالك بالإنترنت والمحاولة مرة أخرى.',
    enablePushNotifications: 'تفعيل الإشعارات الفورية',
    disablePushNotifications: 'إيقاف الإشعارات الفورية',
    pushSubscriptionSuccess: 'تم الاشتراك في الإشعارات بنجاح!',
    pushSubscriptionFailed: 'فشل الاشتراك في الإشعارات.',
    pushUnsubscriptionSuccess: 'تم إلغاء الاشتراك في الإشعارات بنجاح.',
    ...
    willContactSoon: "سيتم التواصل معك في أسرع وقت.",
    myOrders: 'طلباتي',
