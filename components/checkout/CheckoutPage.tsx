...
import { ChevronRightIcon, UploadIcon, CopyIcon, CheckIcon, CheckCircleIcon } from '../icons/Icons';
...
export const CheckoutPage: React.FC = () => {
    ...
    useEffect(() => {
        if (cartItems.length === 0 && !isProcessing && !isConfirmationOpen) {
            window.location.hash = '#/';
        }
    }, [cartItems, isProcessing, isConfirmationOpen]);
