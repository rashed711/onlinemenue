...
export const SearchAndFilter: React.FC<SearchAndFilterProps> = ({
  ...
  const topLevelCategories = useMemo(() => {
    ...
    const categoriesMap = new Map<number, CategoryNode>(categories.map(c => [c.id, { ...c, children: [] as Category[] }]));
    ...
    // Sort the children of each root alphabetically.
  ...
  const categoryContainerClasses = openDropdown !== null
    ? "flex items-start justify-start md:justify-center gap-4 sm:gap-6 flex-wrap py-2"
    : "flex items-start justify-start md:justify-center gap-4 sm:gap-6 overflow-x-auto scrollbar-hide py-2 flex-nowrap";

  return (
    <div id="menu" className="relative py-[5px]">
      {/* Categories */}
      <div ref={dropdownsRef} className={categoryContainerClasses}>
          <button
