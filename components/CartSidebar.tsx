...
interface CartSidebarProps {
  ...
  clearCart: () => void;
  language: Language;
  onPlaceOrder: () => void; // New prop to handle order placement
}
...
export const CartSidebar: React.FC<CartSidebarProps> = ({
  ...
  return (
    <>
      ...
      />
      <div
        className={`fixed top-0 bottom-0 ${language === 'ar' ? 'end-0' : 'start-0'} w-full max-w-md bg-white dark:bg-gray-800 shadow-2xl z-50 transform transition-transform duration-300 ease-in-out ${
