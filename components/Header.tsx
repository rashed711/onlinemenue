        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            <div className="hidden sm:flex items-center gap-4">
              {currentUser ? (
                 <>
                    <a href={currentUser.role === 'admin' ? '#/admin' : '#/profile'} className="flex items-center gap-2 text-sm font-semibold hover:text-primary-500 transition-colors" title={t.profile}>
                ...
                <>
                    ...
                    <a href="#/register" className="text-sm font-semibold bg-primary-500 text-white px-4 py-2 rounded-full hover:bg-primary-600 transition-colors">{t.register}</a>
                </>
              )}
            ...
            <button onClick={onCartClick} className="relative p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">
             ...
             <div className="sm:hidden">
                 <a href={currentUser ? (currentUser.role === 'admin' ? '#/admin' : '#/profile') : '#/login'} className="p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors" title={t.profile}>
