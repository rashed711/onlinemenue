                ...
                <div className="p-6 space-y-6 overflow-y-auto">
                     <div className="bg-slate-50 dark:bg-slate-700/50 p-4 rounded-lg">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                            <div>
                                <p className="font-semibold text-slate-500 dark:text-slate-400">{t.name}</p>
                                <p className="font-bold text-base">{order.customer.name || 'Guest'}</p>
                            </div>
                            <div>
                                <p className="font-semibold text-slate-500 dark:text-slate-400">{t.mobileNumber}</p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-sm">
                        ...
                        <div>
                            ...
                            <p>
                                <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full border ${getStatusChipColor(order.status)}`}>
